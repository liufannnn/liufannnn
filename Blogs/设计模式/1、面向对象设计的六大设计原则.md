...
![开闭原则UML类图对比](https://gitee.com/liufannnn/liufannnn/raw/main/BlogImages/开闭原则UML类图.png)
...
![单一职责原则UML类图对比](https://gitee.com/liufannnn/liufannnn/raw/main/BlogImages/单一职责原则UML类图.png)
...
![依赖倒置原则UML类图对比](https://gitee.com/liufannnn/liufannnn/raw/main/BlogImages/依赖倒置原则UML类图.png)
...
![接口分离原则UML类图对比](https://gitee.com/liufannnn/liufannnn/raw/main/BlogImages/接口分离原则UML类图.png)
...
1. `UITableViewDataSource`含有的方法是 `UITableView` 的代理传给 `UITableView` 一些必要数据供 `UITableView`
...
![迪米特法则UML类图对比](https://gitee.com/liufannnn/liufannnn/raw/main/BlogImages/迪米特法则UML类图.png)
...
![里氏替换原则UML类图对比](https://gitee.com/liufannnn/liufannnn/raw/main/BlogImages/里氏替换原则UML类图.png)
